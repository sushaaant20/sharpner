...
function addNewExpense(e) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/d4e1ec73def94abab05e664dba5080f5/expense",
      expenseDetails
    )
    .then((response) => {
...
window.addEventListener("DOMContentLoaded", (event) => {
  axios
    .get("https://crudcrud.com/api/d4e1ec73def94abab05e664dba5080f5/expense")
    .then((res) => {
...
function deleteExpense(expenseid) {
  axios
    .delete(
      `https://crudcrud.com/api/d4e1ec73def94abab05e664dba5080f5/expense/${expenseid}`
    )
    .then((response) => {
